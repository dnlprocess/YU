...
public class WaterPressureTest 
{
    ...
    @Test
    public void testWaterPressureBase2() {
        final String initialInputPump = "PumpA";
        final String secondInputPump = "PumpF";
        final String[] V = {"PumpA", "PumpD", "PumpD", "PumpB", "PumpC", "PumpF", "PumpD"};
        final String[] W = {"PumpB", "PumpE", "PumpC", "PumpD", "PumpF", "PumpG", "PumpG"};
        final double[] weight = {1.0, 2.0, 30, 12, 9, 60, 23};
        final double expectedMinAmount = 30;
