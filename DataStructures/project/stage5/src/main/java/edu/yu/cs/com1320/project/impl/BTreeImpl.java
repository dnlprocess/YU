...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key,Value> {
    ...
    private static class Entry
    {
        ...
        public void isInMemory(boolean memoryStatus) {
            this.inMemory = memoryStatus;
        }
    }
    ...
    public Value put(Key k, Value v) {
        ...
        if(alreadyThere != null) {
            if (!alreadyThere.isInMemory()) {
                moveToMemory(alreadyThere, k);
            }
    ...
    public void moveToDisk(Key k) throws Exception {
        ...
        if (entry != null && entry.isInMemory() && entry.val != null) {
            this.persistenceManager.serialize(k, (Value) entry.val);
            entry.val = null;
            entry.isInMemory(false);
        }
    }

    private void moveToMemory(Entry entry, Key k) {
        try {
            entry.val = persistenceManager.deserialize(k);
